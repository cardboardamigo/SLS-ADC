...
export default function Sidebar() {
  ...
  return (
    <aside
      className="hidden lg:flex fixed left-0 top-0 bottom-0 flex-col z-50"
      style={{
    ...
    >
      ...
      >
        <button
          onClick={toggleTheme}
          className="flex items-center gap-3 px-4 py-3 rounded-xl transition-all w-full min-h-[48px]"
          style={{
