    ...
    >
      ...
      <div className="relative w-full max-w-[380px] flex flex-col items-center">
        ...
        <div className="flex flex-col items-center mb-8">
          <div
            className="w-24 h-24 flex items-center justify-center mb-5 shadow-lg"
            style={{
          ...
          <div className="w-full">
            ...
            <div className="p-7" style={glassCard}>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                {/* Email */}
                <div>
                  <label htmlFor="email" className="block text-sm font-medium mb-2" style={{ color: "rgba(255,255,255,0.6)" }}>
                    Email
                  </label>
              ...
              {biometricAvailable && (
                <button
                  ...
                  disabled={loading}
                  className="flex h-12 w-full items-center justify-center gap-3 text-sm font-medium active:scale-[0.98] disabled:opacity-50 transition-all mt-3"
                  style={{
                    borderRadius: "var(--bubble-radius-input)",
                    background: "rgba(255,255,255,0.08)",
                    border: "1.5px solid rgba(255,255,255,0.15)",
