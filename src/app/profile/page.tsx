  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 pt-14">
      ...
      <div className="max-w-lg mx-auto px-4 py-4">
        {success && (
          <div className="bg-green-50 border border-green-200 text-green-700 rounded-xl p-3 mb-4 text-center text-sm font-medium">
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 mb-4 text-center">
          <div className="relative inline-block">
            {profile?.profilePicUrl ? (
              ...
              <div className="w-24 h-24 rounded-full bg-[#1e3a5f] flex items-center justify-center mx-auto text-white text-3xl font-bold">
            ...
            <button
              ...
              disabled={uploading}
              className="absolute bottom-0 right-0 bg-[#38b2ac] text-white w-8 h-8 rounded-full flex items-center justify-center shadow-lg"
            >
              {uploading ? (
        ...
        <form onSubmit={handleSave} className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100 mb-4">
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#38b2ac] transition"
            />
          </div>
        ...
        <button
          ...
          className="w-full bg-white text-red-500 py-3 rounded-xl font-semibold border border-red-200 hover:bg-red-50 transition"
        >
          Sign Out
        </button>
      </div>
